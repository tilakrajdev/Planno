            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        {/* <DottedSeparator className="py-7"/> */}
                        <Button className="mt-10 w-fit ml-auto text-white" size="sm" variant="destructive" type="button" disabled={isPending || isResettingInviteCode} onClick={handleResetInviteCode}>
                            Reset Invite Link
                        </Button>
                    </div>
                </CardContent>
            ...
            <Card className="w-full h-full border-none shadow-none">
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <Button className="mt-6 w-fit ml-auto text-white" size="sm" variant="destructive" type="button" disabled={isPending || isDeletingWorkspace} onClick={handleDelete}>
                            Delete Workspace
                        </Button>
                    </div>
                </CardContent>
